...
There is no npm project, bundler, frontend framework, backend, or API key. The page reads JSON and GeoJSON generated by the Python parser, which remains the source of truth.
...
It never writes directly to `main`, and the original GTFS ZIP is not committed.
