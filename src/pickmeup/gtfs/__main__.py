...
def main() -> None:
    ...
    download_parser = subparsers.add_parser("download", help="Download the current official Rapid KL rail feed")
    ...
    curated_parser = subparsers.add_parser("curated", help="Check curated interchange stop IDs against a feed")
